	...
	public class ProductRepositoryTest {
	    ...
	    //Verifies if the save operation on product is working
	    @Test
	    ...
	    //Verifies that retrieving a product by its ID returns the correct result.
	    @Test
	    ...
	    //Verifies that retrieving all products returns the expected list of entries.
	    @Test
	    ...
	    // Verifies that deleting a product by its ID removes it from the database.
	    @Test
	    ...
	    // Verifies that deleting all products clears the repository.
	    @Test
